...
export default function AboutUs() {
  return (
    <div className="bg-white">
      <div className="container max-width: 1024px; flex mx-auto overflow-hidden justify-center m-16">
        <div className="grid grid-cols-2 gap-y-8 gap-12">
          <span className="text-center text-sky font-semibold font-serif text-4xl col-span-full border border-xl-8">
            Why Organic Skin Care Products are Better for You
          </span>
          <span className="text-sky text-md font-mono break-words">
          ...
          <span className="text-sky text-md font-mono break-words">
            ...
            or clean products can eliminate reduce your exposure,which means
            better skin health.
          </span>
          <span className="text-sky text-md font-mono break-words">
            ...
            powerful but gentle on the skin.
          </span>
          <img src={aboutImage} alt="skincare" />
          <div className="flex flex-col gap-28">
            <span className="text-sky text-2xl font-serif break-words tracking-wide leading-loose">
            ...
            <div className="flex flex-col gap-6">
              <span className="text-sky text-2xl font-serif">
                How’s your skin feeling today?
              </span>
              <span className="text-sky font-semibold text-3xl font-serif">
