      ...
      <div className="container mx-auto mt-10 flex items-center justify-center">
        <div className="w-3/4 shadow-md my-10 flex-wrap">
          ...
          <div id="summary" className="w-2/4 px-8 py-10 container">
            ...
            <button className="bg-teal2 py-3 p-6 font-semibold text-sm text-white uppercase rounded-full hover:bg-teal hover:text-gray-800 transition duration-300 ease-in-out">
              Apply
            </button>
            <div className="border-t mt-8">
              ...
              <Link
                to="/checkout"
                className="bg-orange2 font-semibold py-4 p-8 text-sm text-white uppercase w-full rounded-full hover:bg-orange3 hover:text-gray-800 transition duration-300 ease-in-out"
                >
                Order now
              </Link>
            </div>
